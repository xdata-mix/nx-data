...
def main():
    ...
    # Exit code 0 même si quelques chaînes ont échoué (= normal, certaines
    # sont temporairement down). Exit 1 seulement si TOUT a échoué.
    if total == 0:
        print("ERREUR : aucune chaîne récupérée !", file=sys.stderr)
        sys.exit(1)
